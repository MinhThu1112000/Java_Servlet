...
<main>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="input-bao-hanh"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="input-khuyen-mai"
    ...
    <div class="tool-page">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <button id="btn-them" type="button" class="btn btn-primary"
